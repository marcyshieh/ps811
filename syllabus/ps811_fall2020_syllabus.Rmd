...
## `r advdate(mon, 2)`: Do you what you already do but with cool computing tools - part i: create a project and start writing a document in APA style.
...
##  `r advdate(mon, 3)`: Do you what you already do but with cool computing tools - part ii: create a bibliography

* [Bibliographies and citations](https://bookdown.org/yihui/rmarkdown-cookbook/bibliography.html)

##  `r advdate(mon, 4)`: Base R vs. Tidyverse, and how to be comfortable with both.
...
##  `r advdate(mon, 5)`: Some useful functions for your own work and PS 812.
